...
type crdHandler struct {
	...
	converterFactory *conversion.CRDConverterFactory
}
...
func NewCustomResourceDefinitionHandler(
	...
	crdConverterFactory, err := conversion.NewCRDConverterFactory(serviceResolver, authResolverWrapper)
	if err != nil {
		return nil, err
	}
	ret.converterFactory = crdConverterFactory
